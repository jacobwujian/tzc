  ...
  <div class="statistical-manage">
    <a-row :gutter="40">
      ...
      >
        ...
        <FormItem
          ref="formLeft"
          :form-items="leftFormItems"
          :form-data="leftData && leftData.data"
        />
      </a-col>
      <a-col
        class="col-middle"
      ...
      >
        ...
        <FormItem
          ref="formMiddle"
          :form-items="middleFormItems"
          :form-data="middleData && middleData.data"
        />
      </a-col>
      <a-col
        class="col-right"
      ...
      >
        ...
        <FormItem
          ref="formRight"
          :form-items="rightFormItems"
          :form-data="rightData && rightData.data"
        />
      </a-col>
    </a-row>
...
import { cityCode } from '@/utils/typeEnum'
